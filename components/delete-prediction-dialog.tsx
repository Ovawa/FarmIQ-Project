...
export function DeletePredictionDialog({ predictionId, cropName, children }: DeletePredictionDialogProps) {
    ...
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            This will permanently delete the yield prediction for "{cropName}". This action cannot be undone.
          </AlertDialogDescription>
        </AlertDialogHeader>
        {error && (
